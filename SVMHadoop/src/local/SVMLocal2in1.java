 ...
 *
 */
public class SVMLocal2in1 {
	
	public static final int SIFT = 0, CSIFT = 1; 
	...
	public SVMLocal2in1() throws IOException {
	...
	public void run() throws IOException {
		...
		KernelRow[][] b_buffer = new KernelRow[2][b_chunk_size];
		int linecnt = 0;
		while(line != null) {
	...
	public static void main(String args[]) throws Exception {
		if(args == null || args.length != 8) {
			System.out.print(
					 ...
					 "  worker.setB_matrix_sift_file(args[3]);	//e.g. G:\\sift-features.peek\n"+
					 "  worker.setB_matrix_csift_file(args[4]);	//e.g. G:\\csift-features.peek\n"+
					 "  worker.setModel_file_location(args[5]);	//e.g. G:\\sin-models\\concept346.models\n"+
					 "  worker.setOut_prediction_file(args[6]);	//G:\\ground-truth-check\\out-prediction.txt\n"+
					 "  worker.setB_chunk_size(Integer.parseInt(args[7]));//99\n"
			);
			System.exit(1);
		}
		SVMLocal2in1 worker = new SVMLocal2in1();
		
		worker.setRow_a(Integer.parseInt(args[0]));	//e.g. 236697
		worker.setA_matrix_sift_dir(args[1]);	//e.g. G:\\A_feature\\sift
		worker.setA_matrix_csift_dir(args[2]);	//e.g. G:\\A_feature\\csift
		worker.setB_matrix_sift_file(args[3]);	//e.g. G:\\ground-truth-check\\featuers\\evl\\sift-features.peek
		worker.setB_matrix_csift_file(args[4]);	//e.g. G:\\ground-truth-check\\featuers\\evl\\csift-features.peek
		worker.setModel_file_location(args[5]);	//e.g. G:\\sin-models\\concept346.models
		worker.setOut_prediction_file(args[6]);	//G:\\ground-truth-check\\out-prediction.txt
		worker.setB_chunk_size(Integer.parseInt(args[7]));
